            ...
            begin_transition: function(t) {
                ...
                standard: function(t, e) {
                    Website._register.transition.container.html(t), Website._functions.text_reveal(), setTimeout(function() {
                        ...
                        $("header").removeClass("transition remove-nav transition-nav"), $("body").toggleClass("white", !!$("#we-are").length), $("#main").toggleClass("no-scroll", !!$("#work-thumbs").length), $("header").toggleClass("dark", !!$("#we-are").length), $("footer").attr("scroll", $("#we-are").length ? "menu" : "no-menu"), $("footer").attr("scroll", "menu")
                    }, 800), setTimeout(function() {
                        Website._init(!1)
                    }, 1e3), this.complete(e)
                },
    ...
    Agency = {
        ...
        _base: function() {
            $("body").removeClass("init").addClass("white"), $("header").addClass("dark"), $("#culture_text").addClass("ready"), setTimeout(function() {
                $("section#we-are").addClass("active")
            }, 1e3), Website._functions.lighthouse() && $("#we-are").addClass("lh")
        },
        _events: function() {
