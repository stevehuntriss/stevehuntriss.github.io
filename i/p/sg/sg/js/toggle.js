...
var JQ4UFUNCS =
{
    init: function()
    {
        ...
        $.getScript('http://www.jquery4u.com/scripts/htmlentities.js', function()
        {
            ...
            $.each(fns, function(i,fn)
            {
                ...
                if(fnPresence)
                {
                    ...
                    $('#'+fn).after('<div id="'+fn+'-sourcecode" class="sourcecode">'+'<p>Code to Run</p>'+'<pre class="raw brush: js;" id="'+fn+'-raw-runcode">'+functionCodeRun+'</pre>'+'<p id="'+fn+'-resetcontainer">Code to Reset</p>'+'<pre class="raw brush: js;" id="'+fn+'-raw-resetcode">'+functionCodeReset+'</pre>'+'</div>').next().hide();
        ...
        _this.enhanceGetScript();
        var scripts = ['http://www.jquery4u.com/scripts/mybeautifier.js','http://www.jquery4u.com/scripts/beautify.js','http://www.jquery4u.com/scripts/beautify-html.js'];
    ...
    /* helper function to setup $.getScript to handle mutiple scripts */
    enhanceGetScript: function()
    {
